...
def trainNB0(trainMatrix, trainCategory):
    ...
    p1Ratio = sum(trainCategory)/float(numTrainDocs)
    ...
    p0Vect = log(p0Num/p0Denom)  # log，避免下溢出或者浮点数舍入导致的错误，下溢出是由太多很小的数相乘得到的
    return p0Vect, p1Vect, p1Ratio
